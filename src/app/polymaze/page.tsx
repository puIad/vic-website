...
export default function PolymzePage() {
  ...
  useEffect(() => {
    // Initialize YouTube logo animation after loading completes
    if (!isLoading && typeof window !== 'undefined' && (window as any).lottie && ytbLogoRef.current && !ytbAnimRef.current) {
    ...
    <div className="polymaze-page">
      ...
      {!isLoading && (
        <>
          ...
          {/* Polymaze Section */}
          <section id="polymaze" className="hasLights">
